...
const EventHttpMethodMap: Record<EventType, HttpMethod> = {
  ...
  EDIT_MESSAGE_GUILD: HttpMethod.PATCH,
  EDIT_MESSAGE_DM: HttpMethod.PATCH,
  ...
  CHANGE_EMOJI_NAME: HttpMethod.PATCH,
...
class ApiClient {
  ...
  off(event: EventType, callback: ListenerCallback) {
