...
namespace LiventCord.Controllers
{
    ...
    public partial class MessageController : BaseController
    {
        ...
        [Authorize]
        [HttpGet("/api/v1/guilds/{guildId}/channels/{channelId}/messages")]
        ...
        [Authorize]
        [HttpGet("/api/v1/dms/channels/{friendId}/messages")]
        ...
        [Authorize]
        [HttpPost("/api/v1/guilds/{guildId}/channels/{channelId}/messages")]
        ...
        [Authorize]
        [HttpPost("/api/v1/dms/channels/{friendId}/messages")]
        ...
        [HttpPost("/api/v1/discord/bot/messages/{guildId}/{channelId}")]
        [ValidateBotToken]
        ...
        [HttpPost("/api/v1/discord/bot/messages/bulk/{guildId}/{channelId}")]
        [ValidateBotToken]
        ...
        [Authorize]
        [HttpPatch("/api/v1/guilds/{guildId}/channels/{channelId}/messages/{messageId}")]
        ...
        [Authorize]
        [HttpPatch("/api/v1/dms/channels/{friendId}/messages/{messageId}")]
        ...
        [Authorize]
        [HttpDelete("/api/v1/guilds/{guildId}/channels/{channelId}/messages/{messageId}")]
        ...
        [Authorize]
        [HttpDelete("/api/v1/dms/channels/{channelId}/messages/{messageId}")]
        ...
        [Authorize]
        [HttpGet("/api/v1/guilds/{guildId}/channels/{channelId}/messages/attachments")]
        ...
        [Authorize]
        [HttpPost("/api/v1/guilds/{guildId}/channels/{channelId}/messages/{messageId}/pin")]
        ...
        [Authorize]
        [HttpPost("/api/v1/guilds/{guildId}/channels/{channelId}/messages/{messageId}/unpin")]
        ...
        [Authorize]
        [HttpGet("/api/v1/guilds/{guildId}/channels/{channelId}/messages/pinned")]
        public Task<IActionResult> GetPinnedMessages(string guildId, string channelId) =>
            GetPinnedMessagesAsync(guildId, channelId);

        [Authorize]
        [HttpGet("/api/v1/guilds/{guildId}/channels/{channelId}/messages/links")]
        ...
        [Authorize]
        [HttpPost("/api/v1/guilds/{guildId}/messages/search")]
